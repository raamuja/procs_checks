...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .browse-pane .diffline.git{background:#3b0d0d;color:#fecaca;}
  .browse-pane .diffline.prod{background:#0d2e17;color:#bbf7d0;}
...
${DIFF_PROC_ENTRIES}
  ...
  function showDiffDetail(name){
    ...
    renderPane(prodPane, entry.prod, entry.prodLines);
    // Jump straight to the actual difference instead of leaving the user to
    // scroll through the whole procedure body looking for it.
